...
////						  });
						...
						if(ecertExemptionsCodeListGrid.getData() != null)
						{
//							ecertExemptionsCodeListGrid.getData().allRows.forEach(
							ecertExemptionsCodeListGrid.getData().forEach(
								function (item, index)
								{
									if(item == null)
									{
...
//								resetVariables();
						...
						if( has_unsaved ){
							isc.ask( "Edited content(s) is/are not saved. Are you sure to Go Next?", confirmCallback );
						}else{
...
//        	        	fillDicContentVMs();
//        	        	cert_ecertDicContentCombobox.setValue(null);
        	        		var formType = "";
        	       			var listgrid = "";
        	        		if(value == "Minute"){
...
//		      				{
//		      					ecertDicContentVM.setValues(selectedRecord); 
//		      					ecertDicContentVM.old_item = selectedRecord;
//		      				}
		                },
		                getPickListFilterCriteria: function() {
//		        	  		if(ecertExemptionsCodeListGrid.anySelected()){
...
//							  function(item, index){
//								  if(item == ecertDicContentVM.old_item)
//								  {
//									  
//								  }
//							  }
...
//	          }
	    ...
	    isc.IButton.create({
		  	  ...
		  	  click : function () {
		  		  ...
		  		  var curr_date = new Date();
		  		  var form_type = "Exemption Certificate";
		  		  var new_record = {
	  				  id: "tmp_" + curr_date.getHours() + curr_date.getMinutes() + curr_date.getSeconds(),
	  				  ex_code_id: exemptionCodeVM.getValue("id"),
	  				  exemption_type: "",
...
//		selectbox_DicContent_record.optionList = exemptionCodeVM.getValue("ecertDicContent");
		var found = false;
//		var trg_form_type = (vm.prefix == "min")? "Minute":"Exemption Certificate";
