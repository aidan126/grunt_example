isc.DynamicForm.create({
	...
	fields: [
	         ...
	         {name: "billName1", 	title: "Billing Person", colSpan:3, startRow:true, width: 380, required:true, length:40}, 
	         {name: "billName2", 	title: "",    colSpan: 3, startRow:true, 	width:380, length:40},
	         {name: "coName1", 		title: "C/O", colSpan: 3, startRow:true, endRow:true, 	width:380, length:40}, 
	        ...
	        isc.VLayout.create({
	        	...
	        	members: [
					...
					isc.ButtonToolbar.create({
						...
						buttons: [
						          {name:"confirmBtn", title:"Confirm", autoFit:true, 
						        	  click : function () {
...
isc.ButtonToolbar.create({
	ID:"mmoDNDetailSectionForm_ToolBar",
	buttons: [
	          {name:"printBtn", title:"Print", autoFit: true,
	        	  click : function () {
	        		 // TODO
	        		  isc.say('TODO');
	        	  }
	        	  ...
	        	  click : function () { 
	        		  if(mmoDNDetailDynamicForm.validate()){
	        			  ...
	        			  if(demandNoteItems.length==0){
	        				  isc.warn("No Fee assign to this DemandNote");
	        				  return;
//	        				  ,function(value){
//		        				  if(value){
//		        				  }
//		        			  });	
	          ...
	          {name:"addFeeBtn", title:"Add Fee", autoFit: true,
	        	  click : function () {
...
//	        		  mmoDNAddFeeDynamicForm.setValue('dnDemandNoteNo', mmoDNDetailDynamicForm.getValue('demandNoteNo'));
	          ...
	          {name:"removeFeeBtn", title:"Remove Fee", autoFit: true,
	        	  click : function () { 
...
//        			  });
	          ...
	          {name:"cancelDNBtn", title:"Cancel Demand Note", autoFit: true, onControl:"CANCEL_DEMAND_NOTE", 
	        	  click : function () {
...
//						         {name: "dnDemandNoteNo", 	title: "Demand Note No", 	type:"staticText"}, 
						         ...
						         {name: "fcFeeCode", 		title: "Fee Description", 	width:400, startRow:true, colSpan:3, 	optionDataSource:"feeCodeDS", displayField:"engDesc", valueField:"id", 
					...
					isc.ButtonToolbar.create({
						...
						buttons: [
						          {name:"addFeeSaveBtn", title:"Add", autoFit: true,
						        	  click : function () { 
