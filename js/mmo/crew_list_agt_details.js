...
isc.ListGrid.create({
	...
	fields: [
	         ...
	         {name: "birthDate"},
	         {name: "capacityEngDesc", title: "Capacity", dataPath:"capacity.engDesc"},
	         {name: "salary", title: "Salary (HKD)"} // may need to concern USD input
	         ],
	         ...
	         refresh:function(){
	        	 ...
	        	 var coverYymmValue = crewListDetailForm.getValue("vesselIdValue");
	        	 crewListDetailCrewList.setData([]);
	        	 crewListDetailCrewList.fetchData({"vesselId":vesselIdValue, "coverYymm":coverYymmValue});
	         }
});
...
//						        	 pickListHeaderHeight:0,
						         ...
						         {name: "birthDate", 		title: "Birth Date", 	type:"date", required:true},
						         ...
						         {name: "dischargeDate", 	title: "Discharge Date", 	type:"date", required:true},
						         {name: "dischargePlace", 	title: "Discharge Place", 	length:30},
						         {name: "crewCert", 		title: "Cert", 			length:30},

						         {name: "salary", 			title: "Salary", 		type:"integer", decimalPrecision:8, decimalPad:0, required:true,
						        	 validators:[
...
//			    	           isc.TitleLabel.create({contents: "<p><b><font size=2px>Crew List of Agreement Maintenance</font></b></p>"}),
			    	           isc.SectionStack.create({ID:"crewListDetaiSectionContent", membersMargin: 10,
									sections: [
										...
										{name:"seafarerInfoSection", title: "Seafarer Information", expanded: true , resizeable: false, items: [ crewListDetailCrewList]}
										]
			    	           		})
