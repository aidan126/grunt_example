...
var sectionTitle = 	
	isc.Label.create({
		...
		valign: "top",
		wrap: false,
		contents: "<p><b><font size=2px>Summary of Average Wages of Hong Kong Registered Seafarer on Board</font></b></p>"
	});
...
var searchForm = 
	isc.ReportDynamicForm.create({
		...
		numCols: 4,	
		fields: [
					{name: "reportDate", title: "Report Date", required:true,  type: "date", useTextField:true, inputFormat:"DMY", dateFormatter:"toEuropeanShortDate"},
	...
	isc.ReportToolbar.create({
		buttons: [
			{ name:"generateBtn", title:"Generate Report", autoFit: true, disabled: false,
			  click : function () { 
				  if(RPT_MMO_005_Form.validate()){
					  var requestArguments = ["RPT_MMO_005", RPT_MMO_005_Form.getValues()]; 
