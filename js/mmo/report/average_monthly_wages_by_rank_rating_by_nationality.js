...
var searchForm = 
	isc.ReportDynamicForm.create({
		numCols: 6,		
		fields: [
					{name: "from_date", title: "From Date", type: "date", useTextField:true, inputFormat:"DMY", dateFormatter:"toEuropeanShortDate"},
					{name: "to_date", title: "To Date", type: "date", useTextField:true, inputFormat:"DMY", dateFormatter:"toEuropeanShortDate"},
