var rptSrc = "jasper_report_demo/mmo/MMO_Seafarer_Not_Yet_Discharge_over_12_M_Example_20181105.pdf";
...
var sectionTitle = 	
	isc.Label.create({
		...
		valign: "top",
		wrap: false,
		contents: "<p><b><font size=2px>List of Seafarer Not Yet Discharge over 12 months</font></b></p>"
	});
	...
	isc.DynamicForm.create({
		...
		fields: [
					{ name: "report_date", title: "Report Date", 
					  type: "date", useTextField:true, inputFormat:"DMY", dateFormatter:"toEuropeanShortDate", endRow: true
					},
					{ name: "print_order", title: "Print Order", editorType: "comboBox"
					}					
				]
	});
