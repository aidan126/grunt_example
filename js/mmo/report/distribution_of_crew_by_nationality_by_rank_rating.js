...
var sectionTitle = 	
	isc.Label.create({
		...
		valign: "top",
		wrap: false,
		contents: "<p><b><font size=2px>Distribution of Crew by Nationality by Rank/Rating</font></b></p>"
	});
...
var searchForm = 
	isc.ReportDynamicForm.create({
		...
		fields: [
					...
					{name: "rank", title: "Rank", optionDataSource:"rankDS", displayField:"engDesc", valueField:"id", allowEmptyValue:true}					
				]
	});
