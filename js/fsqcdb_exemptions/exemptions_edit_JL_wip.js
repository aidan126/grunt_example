	    			...
	    			isc.IButton.create({ID:"btnExtend",title:"Extend",onControl:"EXEMPT_WRITE||FSQC_ALL",
	    				click:function(){
	    					 isc.ask("Do you want to close this case and create a new one with extended expiry date?", function (value){
	    						 if (value){
	    							 extendExemption();
//	    							 extendExemptionChecking(extendExemption); 
	    						 }
...
// Start commenting by Jacky 20191231	    				
//			    				if (isNull(exemptionEditVM.getValue("id")) || exCodeChoiceChanged || !isEmpty(exemptionEditVM.getChangedValues())) {
//			    					//record changes not yet saved
//			    					saveExemptionRec();
//			    				}
...
//        	    				exJobEditVM.fetchData({"jobno":exemptionEditVM.getValue("id"), "form":"Minute"}, function (dsResponse, data, dsRequest) {
//                                    if (isNull(data) || data.length<=0) {
//                                        console.log("prepare to save record again for insert Exemption_job because no data");
//                                        console.log("exJobEditVM---------missingExemJobForERecordMin = true;");
...
//                                    
//                                });
// End commenting by Jacky 20191231	    				
...
//	        	    			isc.say("Please save record first! "); return;
		    				...
		    				isc.DataSource.get("exemptionJobDS").fetchData({"jobno":exemptionEditVM.getValue("id")}, function (dsResponse, data, dsRequest) {
		    					if (isNull(data) || data.length<=0) {
		    						isc.say("Please save record first! "); return;
		    					}
		    					...
		    					openPrintReportPage(trg_cert_form)(exemptionEditVM.getValue("id"));
		    				});
...
function saveExemptionRec() {
	...
	{
		extendExemptionChecking(function(bool_ok, found_record){
			if(bool_ok)
			{
				saveExemptionRecord();
			}
...
function extendExemptionChecking(callback)
{
...
//    //exemptionJobDS
//    //isc.DataSource.get("exemptionJobDS").fetchData({"jobno":exemptionEditVM.getValue("id"), "form":"Minute"},
//    exJobEditVM.fetchData({"jobno":exemptionEditVM.getValue("id"), "form":ecertRecformType}, function (dsResponse, data, dsRequest) {
//        if (isNull(data) || data.length<=0) {
//            console.log("prepare to save record again for insert Exemption_job because no data");
//            console.log("exJobEditVM---------missingExemJobForERecordCert = true;");
...
//				var content_1 = exJobEditVM.getValue("content_1");
//				
...
//				exJobEditVM.setValue("content_1", content_1);
//				console.log("exJobEditVM before save: " + JSON.stringify(exJobEditVM.getValues()));
//				
//				/*
//				exJobEditVM.saveData(function(dsResponse, data, dsRequest){
//					if (dsResponse.status == 0) {
//						//console.log("exJobEditVM.saveData callback");
//						console.log("exJobEditVM after save: " + JSON.stringify(exJobEditVM.getValues()));
//						if (!isNull(callback))
//							callback();
//					}
//				});
...
//				exemptionJobDS.updateData(exJobEditVM.getValues(), function(dsResponse, data, dsRequest){
//					if (dsResponse.status != 0) {
//		                console.log("dsResponse.status != 0");
//		                return;
//		            }
...
//					exJobEditVM.fetchData({"jobno":exemptionEditVM.getValue("id"),"form":formType});
 ...
 *  ArrData: {
				...
				cert_conditions_ids: Array of PKs of selected conditions,
				min_conditions_ids: [] {obsolete},
...
function saveExemptionRecord(save_ok_callback)
{
	var isAddNew = false;
...
////	            	    	{
////	            	    	exJobEditVM.fetchData({"jobno":exemptionEditVM.getValue("id"),"form":"Exemption Certificate"},function() {     	    	
////	            	    	//exJobEditVM.editRecord();	
////	            	    	console.log("existing history id =" +  exJobEditVM.getValue("id"));
...
//                            var strContent2  ="";
//                            
//                            exJobEditVM.setValue("imono",exemptionEditVM.getValue("imono"));
//                            
//                            console.log("STEP 1" );
//                            // console.log(exemptionEditVM.getValue("id"));
//                            
//                            if (isAddNew==true) {
//                                exJobEditVM.setValue("jobno",exemptionEditVM.getValue("id"));
//                            }
//                            
//                            console.log("jobno=" + exemptionEditVM.getValue("id"));
//                            console.log("STEP 2" );
//                            
//                            //exJobEditVM.setValue("form","Exemption Certificate");
//                            exJobEditVM.setValue("form", ecertRecformType);
//                            console.log("STEP 3" );
//                            
//                            //jacky todo
//                            if (!isNull(exemptionEditVM.getValue("exempted_item")))
//                                exJobEditVM.setValue("ex_type",exemptionEditVM.getValue("exempted_item"));
//                            
//                            console.log("STEP 4" );
//                            console.log("ex_type=" + exemptionEditVM.getValue("exempted_item"));
//                            
//                            exJobEditVM.setValue("form_name","M.?");
//                            console.log("STEP 5" );
//                            
//                            //jacky todo
//                            if (!isNull(exemptionEditVM.getItem("valid_date")))
//                                exJobEditVM.setValue("valid_date",exemptionEditVM.getValue("valid_date"));
//                            
//                            //********************************************************
//                            if (!isNull(exemptionEditVM.getItem("issue_date")))
//                                exJobEditVM.setValue("issue_date",exemptionEditVM.getValue("issue_date"));
//                            
//                            
//                            if (hiddenExCodeLG.getTotalRows()>0) {
//                                if (!isNull(hiddenExCodeLG.getRecord(0).exemption_for))
//                                    exJobEditVM.setValue("exemption_for",hiddenExCodeLG.getRecord(0).exemption_for);
//                            
//                                console.log("STEP 6" );
//                                console.log("exemption_for=" + exemptionEditVM.getValue("exempted_item"));
//                            
//	                            if (isNull(hiddenExCodeLG.getRecord(0).subheading))
//	                                exJobEditVM.setValue("subheading","NO DATA,PLEASE UPDATE EXEMPTION CODE TABLE.");
//	                            else
//	                                exJobEditVM.setValue("subheading",hiddenExCodeLG.getRecord(0).subheading);
//	                            
//	                            
//                            
...
//                                console.log("step = 3");
//                                if (isNull(exJobEditVM.getValue("content_1")) || exJobEditVM.getValue("content_1")=='' )  
...
//                                    console.log("strContent1=" + strContent1);
//                                    exJobEditVM.setValue("content_1",strContent1);
//                                    console.log("exJobEditVM.setValue('content_1')");
//                                }
//	            			}
//                            
//                            /*
