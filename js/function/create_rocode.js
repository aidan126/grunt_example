/***************************************************************************************************************
* Qualified Name	 	/webui/src/main/webapp/js/hkmis_cert/create_rocode.js
* @author 				Neo Pak
* @since				2019-07-30
* ************************************************************************************************************** 
* Change log:
...
function create_rocode(dataSource, tableFields, formFields, idFields, dataFetchModeValue)
{
			...
			if(dynamicForm.validate()){
				isc.ask(promptSaveMessage, function (value){
					if (value){
						...
						dynamicForm.setValue('dic_type', 'RO');
